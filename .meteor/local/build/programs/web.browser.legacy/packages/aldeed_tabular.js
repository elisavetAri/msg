...
var require = meteorInstall({"node_modules":{"meteor":{"aldeed:tabular":{"client":{"main.js":function(require,exports,module){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// packages/aldeed_tabular/client/main.js                                                                              //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
...
var getMongoSort, objectsAreEqual, sortsAreEqual;
module.link("./util", {
  getMongoSort: function (v) {
    getMongoSort = v;
  },
  objectsAreEqual: function (v) {
    objectsAreEqual = v;
  },
  sortsAreEqual: function (v) {
    sortsAreEqual = v;
  }
}, 7);
...
Template.tabular.onRendered(function () {
  ...
  var ajaxOptions = {
    ...
    /*, settings*/
      ...
      var pubSelector = getPubSelector(template.tabular.selector, data.search && data.search.value || null, template.tabular.searchFields, template.tabular.searchCaseInsensitive, template.tabular.splitSearchByWhitespace, data.columns || null, options.columns);
    ...
    headerCallback: function (headerRow) {
      var options = template.tabular.options.get();
      var columns = options.columns;
      $(headerRow).find('td,th').each(function (index, headerCell) {
        var titleFunction = columns[index] && columns[index].titleFn;
        ...
        if (typeof titleFunction === 'function') {
          ...
          var view = new Blaze.View(titleFunction);
  ...
  template.autorun(function () {
    ...
    var columns = tableInit(tabularTable, template); // Set/update everything else
  ...
  template.autorun(function () {
    ...
    if (fields) {
      // Extend with extraFields from table definition
      if ((0, _typeof2.default)(template.tabular.tableDef.extraFields) === 'object') {
  ...
  template.autorun(function (c) {
    ...
    var options = _.extend({}, ajaxOptions, userOptions); //console.log('userOptions autorun', userOptions);
    ...
    if (options.buttonContainer) {
      var container = $(options.buttonContainer, table.table().container());
...
Template.tabular.onDestroyed(function () {
  ...
  if (this.$tableElement.length) {
    var dt = this.$tableElement.DataTable();
    if (dt) dt.destroy();
...
},"getPubSelector.js":function(require,exports,module){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// packages/aldeed_tabular/client/getPubSelector.js                                                                    //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");
...
function getPubSelector(selector, searchString, searchFields, searchCaseInsensitive, splitSearchByWhitespace, columns, tableColumns) {
  ...
  if (searchColumns.length === 0) {
    ...
    searchColumns = _.map(searchFields, function (field) {
      return {
        data: field,
        search: {
          value: searchString
...
function createMongoSearchQuery(selector, searchString, searchColumns, searchCaseInsensitive, splitSearchByWhitespace, columns, tableColumns) {
  ...
  _.each(searchColumns, function (field) {
    // Get the column options from the Tabular.Table so we can check search options
    var column = _.findWhere(tableColumns, {
      data: field.data
    });

    var exactSearch = column && column.search && column.search.exact;
    var numberSearch = column && column.search && column.search.isNumber;
    var searchValue = field.search.value || ''; // Split and OR by whitespace, as per default DataTables search behavior
    ...
    _.each(searchValue, function (searchTerm) {
      var m1 = {}; // String search

      if (exactSearch) {
        if (numberSearch) {
          var searchTermAsNumber = Number(searchTerm);

          if (!isNaN(searchTermAsNumber)) {
            var _searches$push;

            searches.push((_searches$push = {}, _searches$push[field.data] = searchTermAsNumber, _searches$push));
          } else {
            var _searches$push2;

            searches.push((_searches$push2 = {}, _searches$push2[field.data] = searchTerm, _searches$push2));
          }
        } else {
          var _searches$push3;

          searches.push((_searches$push3 = {}, _searches$push3[field.data] = searchTerm, _searches$push3));
        }
      } else {
        var _searches$push4;
        ...
        searches.push((_searches$push4 = {}, _searches$push4[field.data] = searchObj, _searches$push4)); // For backwards compatibility, we do non-exact searches as a number, too,
        // even if isNumber isn't true

        var _searchTermAsNumber = Number(searchTerm);

        if (!isNaN(_searchTermAsNumber)) {
          var _searches$push5;

          searches.push((_searches$push5 = {}, _searches$push5[field.data] = _searchTermAsNumber, _searches$push5));
        }
      }
    });
  });
  ...
  if ((0, _typeof2.default)(selector) === 'object' && selector !== null) {
    result = {
      $and: [selector, {
        $or: searches
      }]
...
module.exportDefault(getPubSelector);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

},"tableInit.js":function(require,exports,module){
...
var cleanFieldName, cleanFieldNameForSearch;
module.link("./util", {
  cleanFieldName: function (v) {
    cleanFieldName = v;
  },
  cleanFieldNameForSearch: function (v) {
...
function tableInit(tabularTable, template) {
  var fields = {};
  var searchFields = []; // Loop through the provided columns object

  var columns = tabularTable.options.columns || [];
  columns = columns.map(function (column) {
    var options = (0, _objectSpread2.default)({}, column);
    ...
    var titleFunction = options.titleFn;
...
function templateColumnOptions(_ref) {
  var data = _ref.data,
      render = _ref.render,
      tmpl = _ref.tmpl,
      tmplContext = _ref.tmplContext;
  if (!tmpl) return {};
  var options = {}; // Cell should be initially blank

  options.defaultContent = ''; // When the cell is created, render its content from
  // the provided template with row data.

  options.createdCell = function (cell, cellData, rowData) {
  ...
  if (data && !render) {
    options.render = function (data, type) {
...
module.exportDefault(tableInit);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

},"tabular.html":function(require,exports,module){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// node_modules/meteor/aldeed_tabular/client/tabular.html                                                              //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
module.link("./template.tabular.js", { "*": "*+" });

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

},"template.tabular.js":function(){
...
}},"node_modules":{"datatables.net":{"package.json":function(require,exports,module){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// node_modules/meteor/aldeed_tabular/node_modules/datatables.net/package.json                                         //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
module.exports = {
...
},"js":{"jquery.dataTables.js":function(require,exports,module){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// node_modules/meteor/aldeed_tabular/node_modules/datatables.net/js/jquery.dataTables.js                              //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
/*! DataTables 1.10.12
...
}}},"jquery":{"package.json":function(require,exports,module){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// node_modules/meteor/aldeed_tabular/node_modules/jquery/package.json                                                 //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
module.exports = {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// node_modules/meteor/aldeed_tabular/node_modules/jquery/dist/jquery.js                                               //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
/*!
...
var exports = require("/node_modules/meteor/aldeed:tabular/client/main.js");
